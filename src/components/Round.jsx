...
export default ({ roundParams, handleLevelUp }) => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      window.removeEventListener('onClick',handleLevelUp)
      window.removeEventListener('onClick',roundParams)
